  ...
  return (
    ...
    >
      <nav className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <button onClick={() => scrollToSection('contact')} className="inline-flex px-6 py-2 rounded-sm bg-accent text-accent-foreground font-medium text-sm hover:opacity-90 transition-opacity">
          Hire Me
        </button>
      </nav>
    </header>
